...
<div class="col-xs-12 col-sm-12 col-md-10" id="panelHome" name="cuerpo">
  <div class="panel panel-success">
    ...
    <div id="estudiantes" class="tab-pane fade in active">
      <div class="panel-body" autoCal="true" formulacal="height-100">
        <div class="row">
          <form id="formActividades" name="formActividades">
                <div class="form-group col-xs-12 col-sm-4 col-md-2" id="registrar" name="registrar">
                  <button type="button" class="btn btn-default btn-sm btn-primary" name="btnSaveActividades" title="Registrar regimen">
    ...
    <!-- Inicio Modal Registro Actividades -->
    <div class="modal fade" id="modal" tabindex="-1" role="dialog" name="modalActividades" data-backdrop="static" data-keyboard="true">
      <div class="modal-dialog" id="cuerpo" role="document">
        <div class="modal-content" id="newCliente">
          <div class="modal-header">
            ...
            <h4 class="modal-title"><center>Registrar Actividades</h4>
          </div>
          <div class="modal-body">
            <form name="formSaveActividad" id="formSaveActividad">
              <hr id="hr" name="hr">
              <div class="form-group">
                  <div class="row">
                    <div class="col-xs-0">
                      <input type="hidden" id="codigo_actividades" name="codigo_actividades">
          ...
          <div class="modal-footer">
            <center>
              ...
              <button type="button" class="btn btn-primary" id="btnSavingActividades" name="btnSavingActividades"  >Registrar</button>
            </center>
          </div>
        </div>
      </div>
  ...
  <script type="text/javascript">
      $.getScript('<?php echo base_url(); ?>js/actividades.js');
  </script>
