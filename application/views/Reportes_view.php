...
<div class="col-xs-12 col-sm-12 col-md-10" id="panelHome" name="cuerpo">
  <div class="panel panel-success">
    ...
    <div id="estudiantes" class="tab-pane fade in active">
      <div class="panel-body" autoCal="true" formulacal="height-100">
        ...
        <form class="noprint" name="formBusqueda" id="formBusqueda">
          <div class="row">
            <div class="col-xs-4">
              <label style="font-size: 20px;">Traer las facturas elaboradas entre dos fechas.</label>
            </div>
            <div class="col-xs-6">
              <label style="font-size: 20px;">Traer las facturas asociadas a un cliente o a un vendedor.</label>
            </div>
            <div class="col-xs-2">
              <label style="font-size: 20px;">Traer las facturas dependiendo de su estado.</label>
            </div>
          </div><br>
          <div class="row">
            ...
            <div class="col-xs-2" id="fecha_salida">
            ...
            <div class="col-xs-2">
              ...
              <select class="form-control" name="estado" id="estado">
                ...
                <option value="E">En Edición</option>
                <option value="A">Finalizadas</option>
    ...
    <script type="text/javascript">
        $.getScript('<?php echo base_url(); ?>js/reportes.js');
    </script>
