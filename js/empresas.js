...
function obtener_barrios(){
 ...
 $.ajax({
   url: "empresas_controller/obtener_barrios",
   type: 'POST',
   data: {
...
var obtener_paises = function(){
 var combo=$('[name=pais]');
 $.ajax({
     url: "empresas_controller/obtener_paises",
     success: function(response) {
         var respuesta = $.parseJSON(response);
         if (respuesta.success === true) {
           combo.empty();
...
function obtener_estados() {
 ...
 $.ajax({
   url: "empresas_controller/obtener_estados",
   type: 'POST',
   data: {
...
function obtener_ciudades(){
 ...
 $.ajax({
   url: "empresas_controller/obtener_ciudades",
   type: 'POST',
   data: {
...
var accionEliminar = function(){
   ...
   bootbox.confirm({
       ...
       callback: function (result) {
           if(result===true){
               $.ajax({
                   url: "empresas_controller/eliminar_provedor",
                   type:"POST",
                   data: {
                       codigo: codigo
                   },
...
var accionModificar = function(){
   ...
   $('[name=formularioEs]').modal()
   $('[name=formularioEs]').find('.modal-title').text("Modificar datos de la empresa");
 ...
 var guardarProveedor = function(){
   ...
   if (error === true) {
     ...
     var fd = new FormData(document.getElementById("formModal"));
         ...
         $.ajax({
           url: 'empresas_controller/guardar_proveedores',
           type: 'POST',
           data: fd,
...
var obtener_proveedores = function(){
   ...
   $.ajax({
       url: "empresas_controller/obtener_proveedores",
       success: function(response) {
           var respuesta = $.parseJSON(response);
...
var guardar_barrio = function(){
 ...
 if (error === true) {
   ...
   var fd = new FormData(document.getElementById("formBarrio"));
       ...
       btnGuardar.attr("disabled", "disabled");
       $.ajax({
         url: 'empresas_controller/guardar_barrio',
         type: 'POST',
         data: fd,
         processData: false, // tell jQuery not to process the data
         contentType: false   // tell jQuery not to set contentType
...
var accionUbicacion = function(){
 ...
 var obtener_ubicacion = function(){
     ...
     var modelFila = '<tr>'+
         ...
         '    </tr>';
     $.ajax({
         url: 'empresas_controller/obtener_ubicacion',
         type: 'POST',
         data: {
             codigo: codigo
         },
   ...
   var codigo_ubi = $(this).attr("codigo");
     bootbox.confirm({
         ...
         callback: function (result) {
             if(result===true){
                 $.ajax({
                     url: "empresas_controller/inactivar_ubicacion",
                     type:"POST",
                     data: {
                         codigo_ter: codigo,
 ...
 var accionUbicacionForm = function(){
   ...
   var guardarUbicacion= function(){
     ...
     if (error === true) {
       ...
       btnGuardar.attr("disabled", "disabled");
       $.ajax({
         url: 'empresas_controller/guardar_ubicacion',
         type: 'POST',
         data: fd,
         processData: false, // tell jQuery not to process the data
         contentType: false   // tell jQuery not to set contentType
   ...
   function obtener_tiposubi(){
     ...
     $.ajax({
         url: "empresas_controller/obtener_tiposubi",
         success: function(response) {
             var respuesta = $.parseJSON(response);
             if (respuesta.success === true) {
               combo.empty();
