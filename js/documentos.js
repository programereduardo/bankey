...
var guardarDocumento = function(){
  ...
  if (error === true) {
    ...
    $.ajax({
      url: 'tipodocumentos_controller/guardar_tipodocumentos',
      type: 'POST',
      data: fd,
      processData: false,
      contentType: false
...
var obtener_documentos = function(){
  ...
  var modelFila = '<tr>'+
      ...
      $.ajax({
        url: 'tipodocumentos_controller/obtener_tipodocumentos',
  ...
  if (invalidDelete === true) {
    ...
    bootbox.confirm({
      ...
      callback: function(result){
        if (result === true) {
          $.ajax({
            url: 'tipodocumentos_controller/inactivar_tipodocumentos',
            type: 'POST',
            data:{
